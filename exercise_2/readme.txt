...
9. To create the top 20 word bar chart in Tableau: pull Word and Count onto columns and rows, then chose bar chart in "Show me". Move your mouse onto the top of the chart and click the small bar chart icon to sort it desc. Then right click in the column name section, choose filter->top->set top 20 by field
