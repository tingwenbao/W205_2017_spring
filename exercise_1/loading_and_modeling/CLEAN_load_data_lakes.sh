...
hdfs dfs -rm /user/w205/hospital_compare/$NEW_FILE1
hdfs dfs -rm /user/w205/hospital_compare/$NEW_FILE2
hdfs dfs -rm /user/w205/hospital_compare/$NEW_FILE3
hdfs dfs -rm /user/w205/hospital_compare/$NEW_FILE4
hdfs dfs -rm /user/w205/hospital_compare/$NEW_FILE5
